...
export default function Signin() {
  ...
  return (
    <div className="bg-black min-h-screen flex flex-col items-center justify-center text-white px-6 py-10">
      
      {/* Title */}
      <h2 className="text-4xl font-extrabold mb-8">Sign In</h2>

      {/* Form */}
      <form className="w-full max-w-lg bg-gray-900 p-8 rounded-2xl shadow-xl flex flex-col gap-6" onSubmit={handleSubmit}>
